...
ActiveRecord::Schema.define(version: 20_170_316_092_704) do
  ...
  create_table 'alexaranks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(website_id created_at), name: 'index_alexaranks_on_website_id_and_created_at', unique: true, using: :btree
